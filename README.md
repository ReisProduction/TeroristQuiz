...
This project is protected under the [MIT](https://choosealicense.com/licenses/MIT) License. For more details, refer to the [LICENSE](https://github.com/ReisProduction/TeroristQuiz/blob/main/README.md) file.
